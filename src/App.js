...
function App() {
  ...
  // Town btn is pressed. Make a fetch call to the Open Weather Map API.
   const searchPressed = () => {
    setError(null);
    setIsLoading(true);
      ...
      <header className="App-header">
        ...
        <div  className="searchbar">
          ...
          />
            ...
            disabled={isSearchDisabled}>{isLoading ? 'fetching...' : 'Search'}</Button>
        </div>
